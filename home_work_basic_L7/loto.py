    ...
    while answer not in answers:
        ...
        if answer == 'y':
            if my_card - x is False:
                new_screen(end='yes')
                print('У Вас нет такой цифры. Вы проиграли! Игра окончена')
                return False
            if len(my_card) == 0:
                new_screen(end='yes')
                print('Вы победили!')
            ...
            if my_card.check(x) is True:
                new_screen(end='yes')
                print('У Вас была такая цифра. Вы проиграли! Игра окончена')
                return False
        elif answer == 'q':
            new_screen(end='yes')
            print('{} вышел из игры. Побеждает {}.'.format(my_card.player, pc_card.player))
            return False
        elif answer == 'cheat':
...
while len(bag) > 0:
    ...
    if pc_card.check(x) is True:
        ...
        if len(pc_card) == 0:
            new_screen(end='yes')
            print('Компьютер победил! Игра окончена')
            break
if len(bag) == 0:
    print("Бочонков не осталось. Ничья")
